...
def do_MLST_check(input_MLST_line_tuples, taxonomy_file, mlst_db_path):
	...
	for i in checked_schemes:
		...
		#### MAY NEED TO EDIT THIS IN FUTURE VERSIONS
		elif i[1] == "ecoli_achtman_4":
			i[1] = "ecoli(Achtman)"
		elif i[1] == "ecoli_2" or i[1] == "Escherichia_coli#2" or i[1] == "ecoli":
			i[1] = "ecoli_2(Pasteur)"
		##############################################
	...
	with open(outfile,'w') as writer:
		writer.write("WGS_ID\tSource\tPulled_on\tDatabase\tST\tlocus_1\tlocus_2\tlocus_3\tlocus_4\tlocus_5\tlocus_6\tlocus_7\tlocus_8\tlocus_9\tlocus_10\n")
